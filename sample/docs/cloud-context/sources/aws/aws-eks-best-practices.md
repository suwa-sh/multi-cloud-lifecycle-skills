---
source_url: "https://aws.github.io/aws-eks-best-practices/"
...
::: md-sidebar__inner
[ Security ]{.md-ellipsis} []{.md-nav__icon .md-icon}

[ Cluster Autoscaling ]{.md-ellipsis} []{.md-nav__icon .md-icon}

[ Reliability ]{.md-ellipsis} []{.md-nav__icon .md-icon}

[ Networking ]{.md-ellipsis} []{.md-nav__icon .md-icon}

[ Scalability ]{.md-ellipsis} []{.md-nav__icon .md-icon}

[[ Cluster Upgrades ]{.md-ellipsis}](upgrades/){.md-nav__link}

[ Cost Optimization ]{.md-ellipsis} []{.md-nav__icon .md-icon}

[ Windows Containers ]{.md-ellipsis} []{.md-nav__icon .md-icon}
:::
::::
:::::
...
This content has been updated and relocated to improve your experience. Please visit our new site for the latest version: [AWS EKS Best Practices Guide](https://docs.aws.amazon.com/eks/latest/best-practices/) on the AWS Docs
...
# Introduction[¶](#introduction "Permanent link"){.headerlink}
...
- [Best Practices for Cost Optimization](cost_optimization/cfm_framework/)
...
## Related guides[¶](#related-guides "Permanent link"){.headerlink}
...
## Contributing[¶](#contributing "Permanent link"){.headerlink}
